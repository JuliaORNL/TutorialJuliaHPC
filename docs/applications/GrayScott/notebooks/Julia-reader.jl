...
# ╔═╡ 454e5dc8-f9a8-11ed-2dc6-a55fbb321970
md"""
## Reading and Plotting an ADIOS-2 file with Julia
"""

# ╔═╡ 0e67690e-23ca-4e1f-907a-a8be8bb25c79
begin
	
import ADIOS2
import CairoMakie

bp_file = "~/tmp/gs-julia-1MPI-1GPU-64L-F32.bp"
...
npixels = 32
# Grid is NxNxN Use Tuples () for selection
start = (         16,       16,  32 )
...
manifest_format = "2.0"
project_hash = "98dac1a9526731518c41fc8b44a9ac158041a99c"

[[deps.ADIOS2]]
deps = ["ADIOS2_jll", "Libdl", "MPI", "Printf", "Test"]
git-tree-sha1 = "5dfbdc9d480849d0eb22a22a82915c6042e63312"
uuid = "e0ce9d3b-0dbd-416f-8264-ccca772f60ec"
version = "1.1.0"

[[deps.ADIOS2_jll]]
deps = ["Artifacts", "Blosc2_jll", "Bzip2_jll", "CompilerSupportLibraries_jll", "JLLWrappers", "LazyArtifacts", "Libdl", "MPICH_jll", "MPIPreferences", "MPItrampoline_jll", "MicrosoftMPI_jll", "OpenMPI_jll", "SZ_jll", "TOML", "ZeroMQ_jll", "libpng_jll", "zfp_jll"]
git-tree-sha1 = "4dac155e906ccab3c058dcffad4e160f0ba6d423"
...
git-tree-sha1 = "aac52b18d80da0c673bb6d08d5fd887f3a8d11e5"
uuid = "d43303dc-dd0e-56c6-b0a8-331f4c8c9bfb"
version = "2.8.0+1"
...
[[deps.SZ_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "HDF5_jll", "JLLWrappers", "LLVMOpenMP_jll", "Libdl", "NetCDF_jll", "Zlib_jll", "Zstd_jll"]
git-tree-sha1 = "373a93c14da7fa8febff7df44395d3ac888968a1"
uuid = "409b0d58-1332-5589-be3b-4d778b0df058"
version = "2.1.12+1"
